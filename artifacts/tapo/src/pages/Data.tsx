...
export default function DataPerumahan() {
  ...
  const [filterKondisi, setFilterKondisi] =
    useState<string>("all");

  const [filterRT, setFilterRT] =
    useState<string>("all");
  ...
  const SortIcon = ({
    ...
    if (sortField !== field) {
      return (
        <ChevronsUpDown className="w-3 h-3 ml-1 text-muted-foreground/50" />
      );
    }
            ...
            <div className="space-y-1.5">
              ...
              >
                ...
                <SelectContent>
                  ...
                  <SelectItem value="berubah">
                    Berubah
                  </SelectItem>

                  <SelectItem value="tidak_berubah">
                    Tidak Berubah
                  </SelectItem>
                </SelectContent>
              </Select>
            ...
            <div className="space-y-1.5">
              ...
              >
                ...
                <SelectContent>
                  ...
                  <SelectItem value="perubahanPagar">
                    Pagar
                  </SelectItem>

                  <SelectItem value="perubahanLuasBangunan">
                    Luas Bangunan
                  </SelectItem>

                  <SelectItem value="perubahanJumlahLantai">
                    Jumlah Lantai
                  </SelectItem>

                  <SelectItem value="perubahanLuasLahan">
                    Luas Lahan
                  </SelectItem>

                  <SelectItem value="perubahanJenisLantai">
                    Jenis Lantai
                  </SelectItem>

                  <SelectItem value="perubahanJenisDinding">
                    Jenis Dinding
                  </SelectItem>

                  <SelectItem value="perubahanJenisAtap">
                    Jenis Atap
                  </SelectItem>
                </SelectContent>
              </Select>
          ...
          <Table className="w-[1800px] max-w-none">
            ...
            <TableHeader className="bg-muted/50 sticky top-0 z-10 shadow-sm">
              ...
              <TableRow>
                ...
                <TableHead
                  className="w-24 cursor-pointer hover:bg-muted"
                  onClick={() =>
                    toggleSort("id")
                  }
                >
                ...
                <TableHead
                  className="w-48 cursor-pointer hover:bg-muted"
                  onClick={() =>
                    toggleSort(
                      "namaKepalaKeluarga",
                    )
                ...
                >
                  <div className="flex items-center">
                    Nama KK
                    <SortIcon field="namaKepalaKeluarga" />
                  </div>
                </TableHead>
                ...
                <TableHead
                  className="w-20 cursor-pointer hover:bg-muted"
                  onClick={() =>
                    toggleSort("rt")
                  }
                >
                ...
                <TableHead
                  className="w-24 text-right cursor-pointer hover:bg-muted"
                  onClick={() =>
                    toggleSort(
                      "luasBangunan",
                    )
                ...
                >
                  <div className="flex items-center">
                    Kondisi
                    <SortIcon field="kondisiBangunan" />
                  </div>
                </TableHead>
                  ...
                  (h, i) => (
                    ...
                    >
                      ...
                      <TableCell className="text-center">
                        ...
                        <Badge
                          variant="outline"
                          className="font-mono text-[10px] px-1.5 border-muted-foreground/30"
                        >
                          {h.klaster}
                        </Badge>
